		...
		<div className="max-w-[1344px] flex flex-col items-center mx-auto my-20">
			...
			<div className="grid grid-cols-6 gap-6 mt-16">
				<a href="" className="relative rounded-lg overflow-hidden">
					...
					<div className="w-full pt-16 pb-4 px-4 bg-game-gradient absolute bottom-0 left-0 right-0">
						<strong className="font-blod text-white block">
							League of Legends
						</strong>
			...
			<div className="pt-1 bg-gradient self-stretch rounded-lg mt-8 overflow-hidden">
				<div className="bg-[#2A2634] px-8 py-6 flex justify-between">
					...
					<button className="py-3 px-4  bg-violet-500 hover:bg-violet-600 ease-in text-white rounded flex items-center gap-3">
